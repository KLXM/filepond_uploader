...
### ⚠️ Breaking Changes
- **Addon-Klassen konsistent auf Namespaces und PascalCase umgestellt**: Eigene PHP-Klassen liegen jetzt unter `KLXM\\FilePond\\...` und verwenden durchgängig gleichartige Klassen- und Dateinamen.
- **Dokumentierte Usage an Namespaces angepasst**: README und README.de zeigen die Verwendung der Helper- und Service-Klassen jetzt mit expliziten `use`-Imports.
