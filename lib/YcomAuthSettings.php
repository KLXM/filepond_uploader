...
/**
 * Verwaltet die Backend-User-Defaults für YCom Media Auth bei FilePond-Uploads.
 *
 * Defaults werden pro Backend-Session gespeichert und beim Upload auf alle
 * neu hochgeladenen Dateien angewendet (Bulk-Pre-Set).
 */
final class YcomAuthSettings
{
    /** Backend-Permission, die für die Verwaltung erforderlich ist. */
    public const PERM = 'filepond_uploader[ycom_media_auth]';

    private const SESSION_KEY = 'filepond_ycom_auth_defaults';
    ...
    /**
     * Ist das Feature in den FilePond-Einstellungen aktiviert?
     */
    public static function isEnabled(): bool
    {
        return self::isAvailable()
            && (bool) rex_config::get('filepond_uploader', 'ycom_media_auth_defaults_enabled', false);
    }
    ...
    /**
     * Setzt die Session-Defaults zurück (z. B. nach Logout-Cleanup).
     */
    public static function clearSessionDefaults(): void
    {
